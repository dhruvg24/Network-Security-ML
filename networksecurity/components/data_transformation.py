...
# during transformation we need to seperate out target column and independent columns 
...
class DataTransformation:
    def __init__(self, data_validation_artifact:DataValidationArtifact, data_transformation_config: DataTransformationConfig):
        # data validation artifact contains train test path 
        try:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        try:
            # in training_pipeline -> __init__.py params are defined in form of key value pairs
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            # double star ensures key value pair
